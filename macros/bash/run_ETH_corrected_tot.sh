...
python frPlots.py ../fakeHistos/ETH_corrected_tot/ Plots/ETH_corrected_tot/qcdwjets_weighted/ qcdwjets
...
cp Plots/ETH_corrected_tot/qcdwjets_weighted/*.p?? /afs/cern.ch/user/c/cheidegg/www/pdfs/ETH_corrected_tot/qcdwjets_weighted
