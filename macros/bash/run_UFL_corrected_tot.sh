...
python frPlots.py ../fakeHistos/UFL_corrected_tot/ Plots/UFL_corrected_tot/qcdwtots_weighted/ qcdwtots
...
cp Plots/UFL_corrected_tot/qcdwtots_weighted/*.p?? /afs/cern.ch/user/c/cheidegg/www/pdfs/UFL_corrected_tot/qcdwtots_weighted
