...
python frPlots.py ../fakeHistos/UFL_corrected_jetd0/ Plots/UFL_corrected_jetd0/qcdwjets_weighted/ qcdwjets
...
cp Plots/UFL_corrected_jetd0/qcdwjets_weighted/*.p?? /afs/cern.ch/user/c/cheidegg/www/pdfs/UFL_corrected_jetd0/qcdwjets_weighted
