...
python frPlots.py ../fakeHistos/ETH_corrected_jetd0/ Plots/ETH_corrected_jetd0/qcdwjetd0s_weighted/ qcdwjetd0s
...
cp Plots/ETH_corrected_jetd0/qcdwjetd0s_weighted/*.p?? /afs/cern.ch/user/c/cheidegg/www/pdfs/ETH_corrected_jetd0/qcdwjetd0s_weighted
