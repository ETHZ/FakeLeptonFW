...
fn = ['FR_2dmap_data.root', 'FR_2dmap_mc.root', 'FR_2dmap_data-ew_central1.root', 'FR_2dmap_ttbar.root']
...
for i in range(n_sets):
	...
	nn[i] = ['FR_data_' + str(run[i]) + '_pure', 'FR_mc_' + str(run[i]), 'FR_data_' + str(run[i]), 'FR_ttbar_' + str(run[i])]
