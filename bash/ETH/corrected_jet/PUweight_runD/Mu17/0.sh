...
#./Fakerates -v 2 -s -t 1 -c config/ETH/corrected_jet/PUweight_runD/Mu17/0.config -i /shome/cheidegg/FakeTrees/TTJets_complete.root                                    -n mu_ttbar3          -x 245.0
#./Fakerates -v 2 -s -t 1 -c config/ETH/corrected_jet/PUweight_runD/Mu17/0.config -i /shome/cheidegg/FakeTrees/TTJets_complete.root                                    -n mu_ttbar4          -x 245.0
#./Fakerates -v 2 -s -t 1 -c config/ETH/corrected_jet/PUweight_runD/Mu17/0.config -i /shome/cheidegg/FakeTrees/TTJets_complete.root                                    -n mu_ttbar5          -x 245.0
#./Fakerates -v 2 -s -t 1 -c config/ETH/corrected_jet/PUweight_runD/Mu17/0.config -i /shome/cheidegg/FakeTrees/TTJets_complete.root                                    -n mu_ttbar6          -x 245.0
