...
make Fakerates && \
############################################### NORMAL SAMPLES
./Fakerates -v 2    -t 2 -c config/ETH_corrected_jet_PUweight_runD_Ele17JMC.config -i /shome/cheidegg/FakeTrees/new2/DoubleElectron-Run2012D-PromptReco-v1.root             -n el_data             -x 1.
./Fakerates -v 2 -s -t 2 -c config/ETH_corrected_jet_PUweight_runD_Ele17JMC.config -i /shome/cheidegg/FakeTrees/new2/WJetsToLNu-TuneZ2Star-8TeV-madgraph-tarball.root       -n el_wjets            -x 37509.0
./Fakerates -v 2 -s -t 2 -c config/ETH_corrected_jet_PUweight_runD_Ele17JMC.config -i /shome/cheidegg/FakeTrees/new2/DYJetsToLL-M-50-TuneZ2Star-8TeV-madgraph-tarball.root  -n el_dyjets50         -x 3532.8
./Fakerates -v 2 -s -t 2 -c config/ETH_corrected_jet_PUweight_runD_Ele17JMC.config -i /shome/cheidegg/FakeTrees/new2/DYJetsToLL-M-10To50filter-8TeV-madgraph.root           -n el_dyjets10         -x 877.0
