...
./Fakerates -v 2 -s -c config/ETH_uncorrected.config -i /shome/mdunser/fakeTrees/DYJetsToLL-M-50-TuneZ2Star-8TeV-madgraph-tarball.root  -n dyjets1       -x 3532.8
./Fakerates -v 2 -s -c config/ETH_uncorrected.config -i /shome/mdunser/fakeTrees/DYJetsToLL-M-10To50filter-8TeV-madgraph.root           -n dyjets2       -x 877.0
